...
def process_client(s):
    ...
    elif "/info/" in pathname:
        try:
            body = read_html_file(HTML_ASSETS + pathname.split('/')[-1] + ".html")
